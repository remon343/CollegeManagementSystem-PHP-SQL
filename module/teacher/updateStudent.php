...
<body>
    ...
    if ($total > 0) {
        ...
        <td>" . $row['Email'] . "</td>
        <td>" . $row['Course'] . "</td>
        <td><a href='editStudent.php?name=$row[Name]&&username=$row[Username]&&dob=$row[Date_of_birth]&&fn=$row[Parent_Name]&&pn=$row[Phone_Number]&&email=$row[Email]&&class=$row[Course]'> Edit</a></td>
